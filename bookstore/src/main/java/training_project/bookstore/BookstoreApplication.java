...
public class BookstoreApplication {
	...
	public CommandLineRunner bookDemo(BookRepository repository, CategoryRepository cRepository, AppUserRepository aRepository) {
		...
		return (args) -> {
			...
			repository.save(new Book("Muumit Juhlakirja", "Paula Nivukoski", "9789511394884", 2021, 27.95, cRepository.findByName("Harrastekirjat").get(0)));
			repository.save(new Book("Vuonna 1984", "George Orwell", "9789510404478", 2014, 11.95, cRepository.findByName("Scifi").get(0)));
			repository.save(new Book("Humiseva harju", "Emily Brontë", "9789511231516", 2008, 12.95, cRepository.findByName("Kaunokirjallisuus").get(0)));
